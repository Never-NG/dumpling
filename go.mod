module github.com/dbakit/dumpling/v5
...
require (
	...
	github.com/pingcap/kvproto v0.0.0-20211011042309-a4518fcacbc8 // indirect
	...
	github.com/tikv/client-go/v2 v2.0.0-alpha.0.20211011083157-49c8dd23f1f0 // indirect
